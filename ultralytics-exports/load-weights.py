...
model.load_weights("yolov8n.pt", strict=False) # Load the weights from the ultralytics model Strict is False because the model is not exactly the same
